...
export const Music: React.FC = () => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      if (!searchQuery) {
        clearSearch();
        if (activeTab === "RADIO")
          fetchRadio(undefined, activeGenre || undefined);
        return;
      }
  ...
  return (
    <div
      className={`h-full flex flex-col font-sans select-none relative ${
    ...
    >
      ...
      {showTokenModal && (
        <div className="absolute inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-8 animate-in fade-in duration-200">
          <div
            className={`w-full max-w-md border rounded-3xl p-8 shadow-2xl space-y-6 ${
              isDark
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-zinc-500 font-medium">
                  Enter your Access Token to enable live search.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <input
                ...
                placeholder="BQ..."
                className={`w-full border p-4 rounded-xl text-xs font-mono outline-none focus:border-green-500 transition-colors ${
                  isDark
              ...
              <p className="text-[9px] text-zinc-600 leading-relaxed px-1">
                Note: You can generate a temporary token from the Spotify
                Developer Console (Web API - Console - Get Token).
              </p>
            </div>
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <aside
          className={`hidden md:flex w-56 border-r p-6 flex-col gap-8 shrink-0 ${
            isDark
        ...
        >
          ...
          <div className="space-y-6 flex-1">
            <div className="space-y-1">
              <h4 className="text-[9px] font-black text-zinc-500 uppercase tracking-widest px-2 mb-2">
                Discovery
              </h4>
              {[
            ...
            <div className="space-y-1">
              ...
              {[
                ...
                <button
                  key={item.label}
                  className={`w-full flex items-center gap-3 px-3 py-2 rounded-xl text-zinc-500 transition-all ${
                    isDark
            ...
            <div className="flex items-center gap-3 mb-3">
              <div
                className={`w-2 h-2 rounded-full ${
                  isUsingSpotify ? "bg-green-500 animate-pulse" : "bg-zinc-400"
                }`}
              />
          ...
          <header className="flex flex-col md:flex-row items-start md:items-center justify-between mb-8 gap-4">
            ...
            <div className="relative group w-full md:w-auto">
              ...
              <input
                ...
                className={`border rounded-full py-2.5 pl-10 pr-4 text-xs outline-none transition-all w-full md:w-72 ${
                  isDark
                    ? "bg-white/5 border-white/10 focus:border-red-600 focus:bg-white/10 text-zinc-300 placeholder:text-zinc-600"
                    : "bg-white border-zinc-200 focus:border-red-600 text-zinc-900 placeholder:text-zinc-400 shadow-sm"
                }`}
              />
              {isSearching && (
          ...
          {!isUsingSpotify && searchQuery && activeTab !== "RADIO" && (
            <div className="mb-8 p-4 bg-yellow-500/5 border border-yellow-500/10 rounded-2xl flex items-center gap-3">
              ...
              <span className="text-xs text-yellow-600/80 font-medium">
                Connect your Spotify account to enable real-time search. Showing
                offline tracks.
              </span>
            </div>
          )}
          ...
          <section className="space-y-8 mb-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
              {displayList.map((track) => (
                ...
                >
                  <div
                    className={`aspect-square rounded-2xl overflow-hidden relative shadow-2xl border ${
                      isDark
                  ...
                  <div
                    ...
                    className={`flex items-center justify-between p-3 rounded-2xl transition-all group ${
                      currentTrack.id === track.id
                        ...
                        : isDark
                        ? "hover:bg-white/5"
                        : "hover:bg-white border border-transparent hover:border-zinc-100 hover:shadow-sm"
                    }`}
                  >
                    <div className="flex items-center gap-4">
                      <img
                    ...
                    <div className="flex items-center gap-8 text-zinc-500">
                      <Heart
                        size={14}
                        className="hover:text-red-500 cursor-pointer hidden md:block"
                      />
      ...
      {/* Player Console */}
      <footer
        className={`h-auto md:h-24 backdrop-blur-3xl border-t flex flex-col md:flex-row items-center px-6 md:px-8 gap-4 md:gap-10 py-4 md:py-0 ${
          isDark
      ...
      >
        <div className="flex items-center gap-4 w-full md:w-auto md:min-w-[240px]">
          <div
            className={`w-12 h-12 md:w-14 md:h-14 rounded-xl shadow-2xl overflow-hidden flex-shrink-0 relative ${
            ...
            {currentTrack.cover && (
              <img
                ...
                className={`w-full h-full object-cover transition-transform duration-500 ${
                  isPlaying ? "scale-105" : "scale-95 grayscale"
                }`}
                alt=""
              />
            )}
          ...
          <div className="flex flex-col min-w-0 flex-1">
            ...
            <span className="text-[9px] font-bold text-zinc-500 uppercase tracking-widest mt-1 truncate">
              {currentTrack.artist}
            </span>
          </div>
          ...
          <div className="flex md:hidden items-center gap-4">
            <button
              onClick={togglePlay}
              className={`w-10 h-10 rounded-full flex items-center justify-center active:scale-95 transition-all shadow-xl ${
        ...
        <div className="hidden md:flex flex-1 flex-col items-center gap-3">
          <div className="flex items-center gap-8">
            ...
            <button
              onClick={togglePlay}
              className={`w-12 h-12 rounded-full flex items-center justify-center hover:scale-110 active:scale-95 transition-all shadow-xl ${
                isDark ? "bg-white text-black" : "bg-black text-white"
              }`}
            >
              {isPlaying ? (
          ...
          <div className="w-full max-w-xl flex items-center gap-3">
            <span className="text-[8px] font-mono text-zinc-500 w-8 text-right">
              {currentTrack.isLive
                ...
                : `${Math.floor(
                    ((progress / 100) *
                      (parseInt(currentTrack.duration.split(":")[0]) * 60 +
            ...
            <div
              className={`flex-1 h-1 rounded-full overflow-hidden relative group cursor-pointer ${
              ...
              <div
                className={`absolute inset-y-0 left-0 transition-all duration-300 ${
                  currentTrack.isLive
                    ...
                    : "bg-black group-hover:bg-red-500"
                }`}
